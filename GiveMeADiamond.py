...
# using asterisk ("*") characters. Please see provided test cases 
# for exact output format.
...
# and will have 2 less *’s than the middle line. This reduction by 
# 2 *’s for each line continues until a line with a single * is
#  printed at the top and bottom of the figure.

# Return null if input is even number or negative (as it is not 
# possible to print diamond with even number or negative number).

# Please see provided test case(s) for examples.

# Python Note
# Since print is a reserved word in Python, Python students must 
# implement the diamond(n) method instead, and return None
#  for invalid input.
